...
from controller_functions import index, register, login, logout, dashboard, show_user, show_users_dogs, show_dog, show_event, show_events,\
...
app.add_url_rule('/users/<id>/dogs/create', view_func=create_dog, methods=['POST'])
app.add_url_rule('/users/<id>/dogs/<dog_id>', view_func=show_dog)
app.add_url_rule('/users/<id>/dogs', view_func=show_users_dogs)
app.add_url_rule('/users/<id>/dogs/<dog_id>/edit', view_func=edit_dog, methods=['GET', 'POST'])
app.add_url_rule('/users/<id>/dogs/<dog_id>/delete', view_func=delete_dog)
